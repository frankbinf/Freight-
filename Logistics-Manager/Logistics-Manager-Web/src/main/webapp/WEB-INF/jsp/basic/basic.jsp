    ...
    <table class="tablelist">
        ...
        <c:forEach items="${list}" var="data">
            ...
            <tr>
                ...
                <td><a href="/basic/basicDispatch?id=${data.baseId}" class="tablelink">更新</a>
            ...
            <c:forEach items="${list}" var="small" >
                <c:if test="${data.baseId eq small.parentId}">
                    <tr>
                        ...
                        <td><a href="/basic/basicDispatch?id=${small.baseId}" class="tablelink">更新</a>
                            <a href="javascript:void(0)" onclick="deleteBasic(${small.baseId})" class="tablelink"> 删除</a></td>
                    </tr>
                </c:if>
        </c:forEach>
            </c:if>
