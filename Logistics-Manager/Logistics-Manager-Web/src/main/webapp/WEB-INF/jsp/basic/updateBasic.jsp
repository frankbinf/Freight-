...
<div class="formbody">
    ...
    <ul class="forminfo">
        <li>
            ...
            <label>数据名称</label><input name="baseName" type="text" class="dfinput" value="${basicData.baseName}" />
            <i></i>
        </li>
        <li><label>数据描述</label><input name="baseDesc" type="text" class="dfinput" value="${basicData.baseDesc}" /><i></i>
        </li>
        <li>
            <label>数据类别</label>
            <div class="cityleft">
                <select class="select1" name="parentId">
                    <option value="-1">属于大类</option>
